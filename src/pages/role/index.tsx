...
import {Button, Col, DatePicker, Form, message, Modal, Row, Tree, TreeSelect} from 'antd';
...
export default () => {
  ...
  const [departmentId,setDepartmentId] = useState<React.Key|null>(null);
